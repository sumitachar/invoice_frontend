...
const logoutButtonStyle = ({ typography: { size }, breakpoints }) => ({
  color: "black",
  ...
  boxShadow: "2px 2px 5px rgba(0, 0, 0, 0.2)", // Subtle shadow effect

  "&:hover": {
    backgroundColor: "rgba(71, 71, 71, 0.9) !important",
    transform: "scale(1.1)", // Slight zoom effect
    boxShadow: "3px 3px 8px rgba(71, 71, 71, 0.9)", // Stronger shadow on hover
  },

  "&:hover svg, &:hover .MuiIcon-root, &:hover .material-icons": {
